Locales['fr'] = {
  ...
  ['cloakroom_prompt'] = 'appuyez sur ~INPUT_CONTEXT~ pour accéder au vestiaire.',
  ['wear_citizen'] = 'tenue civile',
  ['wear_work'] = 'tenue de travail',

  -- garage
  ['spawner_prompt'] = 'appuyez sur ~INPUT_CONTEXT~ pour ouvrir le garage.',
  ...
  ['start_job'] = 'Commencer / Arreter son service',
  ...
  ['client_unconcious'] = 'votre client est ~r~parti. ~s~Cherchez-en un autre.',
