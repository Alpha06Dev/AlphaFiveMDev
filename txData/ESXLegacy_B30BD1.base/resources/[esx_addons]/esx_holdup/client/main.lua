...
RegisterNetEvent('esx_holdup:AlarmStart')
AddEventHandler('esx_holdup:AlarmStart', function(alarm)
	for k,v in pairs(Stores) do
	PlaySoundFromCoord(soundid, "VEHICLES_HORNS_AMBULANCE_WARNING", v.position)
	end
end)
